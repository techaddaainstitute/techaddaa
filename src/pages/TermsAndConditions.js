    ...
    <div className="terms-container">
      <div className="terms-content">
        ...
        <div className="terms-section">
          ...
          <ul>
            <li>
              <strong>"Payment Instrument"</strong> includes credit card, debit card, bank account, prepaid payment instrument, Unified Payment Interface (UPI), Immediate Payment Service (IMPS) or any other methods of payments which shall be developed or added or deployed by banks and financial institutions from time to time.
            </li>
            <li>
            ...
            <li>
              <strong>"Transaction"</strong> shall refer to the order or request placed by the User with the Merchant to purchase the products and/or services listed on the Platform by paying the Transaction Amount to the Merchant.
            </li>
            <li>
              <strong>"Transaction Amount"</strong> shall mean the amount paid by the User in connection with a Transaction.
            </li>
            <li>
              <strong>"User/Users"</strong> means any person availing the products and/or services offered on the Platform.
            </li>
            <li>
              <strong>"Website"</strong> shall mean www.instamojo.com or the mobile application.
            </li>
          </ul>
        </div>
        ...
        <div className="terms-section">
          ...
          <p>
            You agree that if you have any question or complaint with regard to any product and/or service availed on our Platform, or pertaining to the Transaction, including but not limited to, double debit of Transaction Amount, fraudulent Transaction, unauthorized Transaction, refund requests, etc., you may reach out to us at{' '}
        ...
        <div className="terms-section">
          <h2>DISCLAIMER</h2>
          <p>
            Upon initiating a Transaction, you as a User are entering into a legally binding and enforceable contract with us to purchase the products and/or services, and you shall pay the price as listed on the Platform through legitimate and legal sources of funds and through the accepted Payment Instruments. You shall provide accurate payment details to the secure payment system for making purchase on the Platform. The information provided by you may be utilized or shared with any third party if required in relation to fraud verifications or by law, regulation or court order.
          </p>
          <p>
            We expressly disclaim all liabilities that may arise as a consequence of any unauthorized use of a User's Payment Instrument. All payments undertaken by you are subject to your own risk and volition. We shall not be liable for any loss or damage occurred to you arising directly or indirectly due to the decline of authorization for any Transaction, malfunction, errors and/or unscrupulous activities.
          </p>
          <p>
            If you receive a User identification code, order ID, password or any other piece of information as part of our security procedures, you must treat such information as confidential. You must not disclose it to any third party. The content on our Platform is provided for general information only. The information provided does not amount to advice from us in any manner and should not be relied upon.
          </p>
          <p>
            Where our Platform contains links to other websites and resources provided by third parties, these links are provided for your information only. Such links should not be interpreted as approval by us of those linked websites or information you may obtain from them. This Platform includes information and materials uploaded by other Users of the Platform. You understand that such information and materials have not been verified or approved by us. The views expressed by other Users on our Platform do not represent our views or values.
          </p>
          <p>
            We do not guarantee that our Platform will be secure or free from bugs or viruses. You are responsible for configuring your information technology, computer programs and platform to access our Platform. You must use your own virus protection software.
          </p>
        </div>
